            ...
            <div className="container my-5">
                <div class="row featurette d-flex justify-content-center align-items-center">
                    <div class="col-md-7 my-4">
                        ...
                        <p class="lead">To provide multiple utilities for SHEEDA coin holders and make it a native asset that is interoperable across the charity and the social media ecosystem.</p>
                    </div>
